...
const AddCard = () => {
  const option = Country.getAllCountries();
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2  gap-4 lg:gap-32   mb-4">
              <div class="relative border border-ghost rounded xl:w-[300px] lg:w-[250px] mx-lg:w-full">
                <input
                  type="text"
                  id="floating_filled"
                  class="block  p-4 w-full bg-transparent text-base text-gray-900 appearance-none dark:text-white dark:border-gray-600  focus:outline-none  peer "
                  placeholder=" "
                  required
                />
                <label
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2  gap-4 lg:gap-32 mb-4">
              ...
              <div className="grid grid-cols-2 gap-2 relative mt-6">
                <div class="relative border border-ghost rounded lg:w-[100px] w-full">
                  <input
                    type="text"
                    id="floating_filled"
                    class="block  p-4 w-full bg-transparent text-base text-gray-900 appearance-none dark:text-white dark:border-gray-600  focus:outline-none  peer "
                ...
                <div class="relative border border-ghost rounded lg:w-[175px] w-full ml-6">
                  <input
                    type="text"
                    id="floating_filled"
                    class="block  p-4 w-full bg-transparent text-base text-gray-900 appearance-none dark:text-white dark:border-gray-600  focus:outline-none  peer "
            ...
            <div className="grid grid-cols-1  mt-4 mb-4 w-[620px]">
              <div class="relative border border-ghost rounded  w-full">
                <input
                  type="text"
                  id="floating_filled"
                  class="block  p-4 w-full bg-transparent text-base text-gray-900 appearance-none dark:text-white dark:border-gray-600  focus:outline-none  peer "
