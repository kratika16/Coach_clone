    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4 z-10 mt-8">
        <div className="relative border border-ghost rounded ">
          ...
          <label className="absolute text-base  text-endeavour dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">
            First Name*
          </label>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        ...
        <div className="relative border border-ghost rounded bg-gray-200">
          <label className="absolute text-xs  text-endeavour dark:text-gray-400 px-4 pt-1 pb-2">
            Email Address*
          </label>
          <input
            type="text"
