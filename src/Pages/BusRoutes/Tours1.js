    ...
    <>
      <div className="container mx-auto my-10 px-16">
        <div className="md:flex">
          <div className="sm:w-2/3 md:pr-3 mx-md:w-full sm:pb-10 md:w-1/3">
            <div className="overflow-hidden md:h-[395px] rounded-md -mb-2 sm:w-auto">
              <img
                alt="Bus Tours"
                src={BusTours}
          ...
          <div className="md:w-2/3 md:pr-3 mx-md:w-full sm:w-full">
